...
export const BEDS: Bed[] = [
  ...
  { id: 'bed-101-4', roomId: 'ward-101', number: '101-4', status: 'cleaning', position: { x: -15, y: 0.6, z: -6 }, cleaningPriority: 3 },
  ...
  { id: 'bed-103-2', roomId: 'ward-103', number: '103-2', status: 'cleaning', position: { x: -15, y: 0.6, z: 10 }, cleaningPriority: 1 },
  ...
  { id: 'bed-103-4', roomId: 'ward-103', number: '103-4', status: 'cleaning', position: { x: -15, y: 0.6, z: 14 }, cleaningPriority: 5 },
  ...
  { id: 'bed-202-4', roomId: 'ward-202', number: '202-4', status: 'cleaning', position: { x: 21, y: 0.6, z: 4 }, cleaningPriority: 2 },
...
export const CORRIDOR_SEGMENTS: CorridorSegment[] = [
  { id: 'cor-1', position: { x: 0, z: -14 }, size: { width: 10, depth: 8 }, pressureLevel: 3 },
  { id: 'cor-2', position: { x: 0, z: -5 }, size: { width: 10, depth: 10 }, pressureLevel: 2 },
  { id: 'cor-3', position: { x: 0, z: 5 }, size: { width: 10, depth: 10 }, pressureLevel: 1 },
  { id: 'cor-4', position: { x: 0, z: 15 }, size: { width: 10, depth: 8 }, pressureLevel: 2 },
];
