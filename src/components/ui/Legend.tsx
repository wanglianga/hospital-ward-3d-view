...
import { BED_STATUS_COLORS, BED_STATUS_LABELS, PRESSURE_COLORS } from '@/utils/colors';
...
export function Legend() {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-20">
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/50 p-4 min-w-[180px]">
